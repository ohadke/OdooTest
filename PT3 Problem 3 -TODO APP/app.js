...
/*UI CHANGES: Make A logo and web tittle, changed CSS of some class ,made the page responsive with live effects.
add numbers to the task but not neccesary.

Should Split the components to sperate files , Make the Todo A component instead of a const.
the funcionaltity works great.
I after some checkes of the regular app i did not see any reason to change the funcionality of the app


THINGS THAT I HAVE LEARNED: the concepts of modulare progrraming and using components and XML,
working with owl FW hooks and lifecycle methods, what it is Event bus which trigger an update